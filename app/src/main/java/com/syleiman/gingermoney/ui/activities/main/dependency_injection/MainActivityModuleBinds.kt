...
import com.syleiman.gingermoney.ui.activities.main.headers.payments.PaymentsHeaderLinkImpl
...
abstract class MainActivityModuleBinds {
    ...
    @Binds
    @ActivityScope
    abstract fun providePaymentsHeaderLink(bridge: PaymentsHeaderLinkImpl): PaymentsHeaderLink
}